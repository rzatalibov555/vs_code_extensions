...
export declare const make: <objectT, valueT = unknown, valueT2 = unknown>(source: RawSource<objectT> | Source<objectT, valueT, valueT2> | ((object: objectT) => valueT) | (RawSource<objectT> | Source<objectT, valueT, valueT2> | ((object: objectT) => valueT))[]) => (a: objectT, b: objectT) => CompareResultType;
export declare const lowerCase: (a: string, b: string) => CompareResultType;
